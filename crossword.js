//=============================================
//  VARIABILI GLOBALI E FUNZIONI UTILI
//=============================================
...
function GetWordsFromInput () {
    wordArr = [];
    var w = document.getElementsByClassName("line");
    for (var i = 0, val; i < w.length; i++) {
    ...
    this.onkeydown = function (e) {
        ...
        if (key === 8) {
            if (boardChar.char[focusIndex].prev != null) {
                ...
                var isEnd = (boardChar.char[focusIndex].next === null);
                document.getElementsByClassName('char')[boardChar.char[focusIndex].prev.index].focus();
                if (isEnd) {
                    document.getElementsByClassName('char')[boardChar.char[focusIndex].index].value = "";
                    document.getElementsByClassName('char')[boardChar.char[focusIndex].next.index].value = "";
                }
            }
        }
    }
...
//=============================================
//  GESTIONE EVENTI CON jQuery PER I BOTTONI CHECK E RESET
//=============================================
$(document).ready(function () {
    $("#btnCheck").click(function () {
        ...
        $(".square input").each(function () {
            ...
            const correctLetter = $(this).attr('data-letter').toUpperCase();
            if (inputVal !== correctLetter) {
                allCorrect = false;
                $(this).val('');
            }
        });
        ...
        if (allCorrect) {
            messageText.text("godo, brava babe");
        } else {
            messageText.text("scarsetta, riprova");
        }
        $("#overlay, #messageBox").addClass("show");
    });

    $("#closeMessage, #overlay").click(function () {
        $("#overlay, #messageBox").removeClass("show");
    });
